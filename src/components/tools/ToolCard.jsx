    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 14 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          {isBuiltin && (
            <span style={{ fontSize: 9, color: "#f97316", background: "rgba(249,115,22,0.1)", padding: "2px 6px", borderRadius: 6, fontWeight: 600, letterSpacing: "0.03em" }}>BUILT-IN</span>
          )}
          <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
            ...
            <span style={{ fontSize: 10, color: isActive ? "#22c55e" : "#ef4444", fontWeight: 500 }}>{isActive ? "Active" : "Offline"}</span>
          </div>
        </div>
      </div>
      ...
      <div style={{ marginTop: 12, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        {tool.tool_type === "custom" && (
          <span style={{ fontSize: 10, color: "#444", display: "flex", alignItems: "center", gap: 3 }}>
            <Code style={{ width: 10, height: 10 }} /> Custom
          </span>
        )}
      </div>
    </button>
