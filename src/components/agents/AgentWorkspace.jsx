  ...
  return (
    <div style={{ ...noSelect, height: "100%", display: "flex", flexDirection: "column", background: "#0a0a0a", position: "relative", overflow: "hidden" }}>
      ...
      <style>{`
        ...
        .chat-markdown { font-size: 14px; line-height: 1.6; color: #e5e5e5; max-width: 100%; }
        .chat-markdown p { margin: 0 0 0.75em; }
        .chat-markdown p:last-child { margin-bottom: 0; }
        .chat-markdown h2 { font-size: 1.1em; font-weight: 700; color: #f5f5f5; margin: 1em 0 0.5em; line-height: 1.3; }
        .chat-markdown h2:first-child { margin-top: 0; }
        .chat-markdown h3 { font-size: 1em; font-weight: 600; color: #f5f5f5; margin: 0.85em 0 0.4em; line-height: 1.35; }
